...
public class Course {
    ...
    public Course(String courseId, String name, int credits, 
                  List<String> prerequisites, double averageGPA, double aRate,
                  String professor, double profRating, 
    ...
    public String toString() {
        return String.format("%s: %s (%d credits, GPA: %.2f, A-rate: %.0f%%, Prof: %s)", 
            courseId, name, credits, averageGPA, aRate * 100, professor);
    }
}
